            ...
            <div className="relative">
                <div className="absolute -top-10 sm:-top-20 left-5 sm:left-10 w-[80vw] sm:w-[25vw] max-sm:gap-5 h-auto rounded-md shadow-md bg-white shadow-gray-500 p-5 flex flex-col items-center">
                    ...
                    <div className="flex flex-col items-center gap-1">
                        <h1 className="text-[1.2rem]"><strong>{ recipient.recipientProfile?.username}</strong></h1>
                            ...
                            <span> Available : </span>
                            {
                                !showToggle && (
                                    <ToggleButton 
                                        ...
                                        Id={recipient.recipientProfile?.recipientId}
                                    /> 
                                )
                            }
                            {
            ...
            <div className="w-full flex flex-col items-center justify-center sm:w-4/6 absolute max-sm:top-[70vh] right-0 mt-6 sm:sm:px-5">
                ...
                <ul className="flex flex-col gap-4 w-3/4 my-10 leading-10">
                    ...
                    <li className="w-full flex items-center justify-between border-b-[1px] border-b-black sm:px-5">
                        ...
                        <p>
                          {recipient.recipientDetail?.AttendeesPhno} 
                        </p>
                    </li>
                    <li className="w-full flex justify-between border-b-[1px] border-b-black sm:px-5">
                    ...
                    <li className="w-full flex justify-between border-b-[1px] border-b-black sm:px-5">
                        <h3>Email</h3>
                        <p>
                           {recipient.recipientDetail?.email} 
                        </p>
                    </li> 
                </ul>
                <div className="mb-10">
                    {
                        ...
                        <div className="mb-10 flex gap-5">
                            ...
                            <span 
                                ...
                                onClick={()=>navigate(`/${recipient.request?._id}/otp`)}
                            >
