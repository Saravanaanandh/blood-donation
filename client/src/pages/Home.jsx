                ...
                }
                {
                    authUser && (
                        <div className="relative w-full h-full"> 
                            <div className=" w-full absolute flex flex-col sm:top-[5vh] right-[85vw] sm:right-[95vw] gap-10">
                                <div className="w-[70vw] sm:w-[50vw] flex flex-col gap-5">
                                    <h1 className="text-[1.7rem] sm:text-[2.2rem] text-red-500"><strong>A Small Drop Can Make a Big Difference! 🌍</strong></h1>
                                    <p className="w-[40vw] sm:w-[35vw] text-[1.1rem] sm:text-[1.3rem]">
                                ...
                                <div className="flex gap-5">
                                    <Link to='/donate'>
                                        <button className="text-nowrap hover:scale-105 cursor-pointer rounded-md transition-all duration-200 text-red-500 border-[1px] border-red-500 px-2 sm:px-4 py-1 sm:py-2" > 
                                            Donate Now
                                        </button>
                                    </Link>
                                    <Link to='/request'>
                                        <button className="text-nowrap hover:scale-105 cursor-pointer transition-all duration-200 bg-red-500 rounded-md text-white px-2 sm:px-4 py-1 sm:py-2" > 
                                            Request Blood
                                        </button>  
                                    </Link>
                                </div> 
